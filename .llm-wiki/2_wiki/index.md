...
- [Mobile Fast-Track UI & State Bridging Lessons](lessons-learned/mobile-fast-track-ui.md) - บันทึกการสร้างหน้าจอ Fast-Track สำหรับมือถือ, การทำ Client-Side Watermarking, ระบบ Draft ด้วย localStorage และการเชื่อมต่อ State (Bridge) ให้กับ react-hook-form
...
- [QSMS Project Overview](architecture/project-overview.md) - Current high-level map of the Next.js portal, module boundaries, API route responsibilities, Supabase/GAS split, and operational notes.
